...
export default function CompareFlow() {
  ...
  return (
    <main className="min-h-screen lg:px-[40px] xl:px-[30px] 2xl:px-[100px]">
      <section
        className="
    mx-auto grid w-full max-w-[1380px] grid-cols-1
    gap-10 pb-12 pl-5 pr-4 pt-5
  ...
  "
        ...
        <div className="w-full max-w-[510px]">
          ...
          <Link
            ...
            className="
              ...
              gap-[5px] rounded-full bg-white py-2 pl-2 pr-[14px]
              font-inter text-[13px] font-medium text-secondary
    ...
    text-[30px] font-[645] leading-[36px]
              ...
              <div className="relative">
                <input
                  ...
                  className="
                    ...
                    font-inter text-[15px] font-normal
                ...
                >
                  <span
                    className={`min-w-0 truncate ${
                      selectedAddress ? ' selectedtext-[#344054]' : 'text-[#667085]'
                    }`}
                  >
  ...
  "
    ...
    568px
  "
              className="scale-[0.92] bg-[#E9EAEB] object-contain object-center"
            />
          </div>
        </div>
      </section>
  ...
  return (
    <button
      ...
      className={`
        ...
        ${
          selected
            ? 'border-[#00897B] bg-[#E6F4F2] text-[#00897B]'
